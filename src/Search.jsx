...
export default function Search({ setCity, unit, setUnit }) {
  ...
  return (
    <div className='flex flex-row items-center justify-center my-6'>
        <input type="text" placeholder='Search' onChange={(e) => setPlace(e.target.value)} onClick={handleBtnClick} value={place} className=' p-2 shadow-xl max-sm:text-xs shadow-gray-900 w-full text-xl font-light mx-2 focus:outline-none capitalize'/>
